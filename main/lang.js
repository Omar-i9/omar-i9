...
(() => {
  ...
  const translations = {
    ...
    en: {
      ...
      projectTitle3:    'May take a while to load the page for the first time',
      projectDesc5:    'The control panel for the electrical device — battery and real motor, WebSocket, HUD.',
      projectName:      'Taamenn',
